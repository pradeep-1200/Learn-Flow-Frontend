        ...
        <div className="space-y-6">
            <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex space-x-4">
                    <div className="bg-orange-50 dark:bg-orange-900/40 text-orange-600 dark:text-orange-400 px-4 py-2 rounded-lg font-bold border border-orange-100 dark:border-orange-800">
                        🔥 Study Streak: {overview.streakCount || 0} days
                    </div>
                </div>
            </div>
